...
namespace YoutubeExtractor
{
    ...
    public static class DownloadUrlResolver
    {
        ...
        {
            //TEST = http://www.youtube.com/watch?v=UxxajLWwzqY
            ...
            if (queries.ContainsKey(SignatureQuery))
            {
                ...
                if (videoInfo.DownloadUrl != HttpHelper.ReplaceQueryStringParameter(videoInfo.DownloadUrl, SignatureQuery, decrypted) && decrypted != "")
                {
        ...
        {
            //https://github.com/flagbug/YoutubeExtractor/issues/332
        ...
        private static string GetHtml5PlayerVersionOld(JObject json)
        {
            try {
        ...
        private static string GetHtml5PlayerVersioOld2(JObject json)
        {
        ...
        private static string GetHtml5PlayerVersionOld2(JObject json)
        {
            var regex = new Regex(@"player_ias-(.+?).js");

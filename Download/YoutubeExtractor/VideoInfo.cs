...
namespace YoutubeExtractor
{
    ...
    public class VideoInfo
    {
        ...
        /// 
        /// </summary>
        public VideoInfo(VideoType VideoType, string Title, string DownloadUrl, int Resolution) : this(1, VideoType,Resolution, false, AudioType.Unknown, 0, AdaptiveType.None)
        {
